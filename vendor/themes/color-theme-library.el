...
;;     (font-lock-comment-face ((t (:bold t :foreground "gray72"))))
     ...
     (font-lock-string-face ((t (:bold t :foreground "tomato"))))
...
;;     (highlight ((t (:background "red" :foreground "yellow"))))
     ...
     (paren-blink-off ((t (:bold t :foreground "DodgerBlue4"))))
     (paren-match ((t (:bold t :background "red" :foreground "yellow"))))
     (paren-mismatch ((t (:bold t :background "DeepPink"))))
     (pointer ((t (:background "white"))))
     (primary-selection ((t (:bold t :background "medium sea green"))))
     (red ((t (:foreground "red"))))
;;     (region ((t (:background "red" :foreground "yellow"))))
;;     (region ((t (:background "#0EAA2F" :foreground "yellow"))))
     (region ((t (:bold t :background "darkgreen" :foreground "yellow"))))
     (right-margin ((t (nil))))
     (secondary-selection ((t (:background "gray91" :foreground "sienna3"))))
     (show-paren-match-face ((t (:bold t :background "cyan3" :foreground "blue"))))
     (show-paren-mismatch-face ((t (:bold t :background "red" :foreground "blue"))))
